...
<a href="https://github.com/Maxymus27"><img src="https://img.shields.io/badge/GitHub-Maxy12--spec-4B0082?style=for-the-badge&logo=github&logoColor=white"/></a>
<a href="https://github.com/Maxymus27"><img src="https://img.shields.io/badge/Portfolio-GitHub%20Profile-483D8B?style=for-the-badge&logo=googlechrome&logoColor=white"/></a>
...
**Not currently a focus.** My current specialization is backend development rather than JavaScript/React/TypeScript frontend development.
...
**Learning / next-stage backend technologies:** JPA · Hibernate · Spring Security · JWT · Docker · AWS
...
|---|---|---|
| Generative AI | Working Knowledge | Practical use of generative AI tools for productivity, problem solving, learning, and software-development workflows |
| Prompt Engineering | Working Knowledge | Structured prompting for improving AI-assisted tasks and outputs |
| AI Tools | Practical | Using AI tools to streamline repetitive workflows and support development |
| AI Integration | Learning | Exploring how AI capabilities can be integrated into Java/Spring backend applications |
| Spring AI | Learning | Building toward AI-powered Java/Spring applications and LLM API integration |
| LLM Applications | Learning | Exploring LLM API integration, RAG, AI agents, and application-level AI workflows |
...
| **Scale** | Student record management backend |
| **Performance** | REST-based backend designed for structured CRUD operations |
| **Security** | Security is a planned next-stage enhancement through Spring Security/JWT |
| **Impact** | Demonstrates practical backend development, API design, and database integration |
| **Repository** | [View on GitHub](https://github.com/Maxymus27/cognevance_studentManagementSystem) |
...
- This is currently my primary completed Spring Boot project and the foundation of my Java backend development journey.
...
**Skills:** `Python` `Automation` `Web Scraping` `Excel` `CSV` `AI Tools` `Data Processing` `Team Coordination`
...
| Recognition | Details |
|---|---|
| ⭐ **4★ CodeChef** | Achieved a 4-star rating on CodeChef |
| 🔥 **200-Day Coding Streak** | Maintained a 200-day coding streak |
| 💻 **Competitive Programming** | Practiced competitive programming problems up to 1000 difficulty |
...
> Additional workshops and participation certificates are intentionally not used as primary certifications here, keeping the profile focused on the strongest relevant credentials.
